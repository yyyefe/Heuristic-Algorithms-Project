...
def baslat():
    ...
    leaderFitness, best_hyperparameters, best_accuracy = whale_optimization_algorithm_randomForest(
...
def whale_optimization_algorithm_randomForest(population_size, num_iterations, param_grid, Xtrain_scaled, ytrain, Xtest_scaled, ytest):
